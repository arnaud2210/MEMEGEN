...
export default function Register({ mainClassName, cardClassName, logoMainClassName, logoText }: { mainClassName: string, cardClassName: string, logoMainClassName: string, logoText: string }) {
    ...
    const fetch = () => {
        ...
        register(registerRequest, navigate, setLoading)
    }
    ...
    const handleOnEmailChanged = (event: any) => {
        setEmailInput(event.target.value)
    }

    const handleOnFullnameChanged = (event: any) => {
        ...
        <>
            <div className={mainClassName}>
                <div className={cardClassName}>
                    ...
                    <p className="mb-5 text-lg uppercase font-semibold leading-5">Inscription</p>
                    <form>
                        <input onChange={handleOnFullnameChanged} className="w-full border mb-2 h-10 px-5" type="text" placeholder="Fullname" name="" id="" />
                        ...
                        <div className="w-full h-10 flex items-center justify-center text-sm">
                            ...
                            <Link to={'/authentication/login'}>
                                <span className="text-blue-600 hover:text-blue-700 ml-1">Se connecter.</span>
                            </Link>
                        </div>
                    </form>
                </div>
